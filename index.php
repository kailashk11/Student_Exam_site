...
body {
    background: url(kk.jpg) no-repeat center;
            ...
            <div class="login-form">
                ...
                <div class="signin_wthree">
                    <form  action="sin.php" method="get">
                        <div class="group">
                           Name.
                            <input  type="text" class="input" name="contact"  maxlength="10"  value="<?php if(isset($_COOKIE["member_login1"])) { echo $_COOKIE["member_login1"]; } ?>"required>
                        </div>
                        <div class="group">
                            Roll No.
                ...
                <div class="signup_wthree">
                    <form action="sup.php">
                     ...
                     <div class="group">
                          std
                            <input  type="number" class="input" name="faddress" required>
                        </div>
